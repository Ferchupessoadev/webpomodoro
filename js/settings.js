...
export default class Settings {
  ...
  changeAutoBreaks(autoBreakHTML) {
    ...
    let autoBreakCircle =
      sectionBreakHTML.lastElementChild.firstElementChild.lastElementChild;
    let autoBreakColor =
      sectionBreakHTML.lastElementChild.firstElementChild.firstElementChild;
  ...
  openModalConf() {
    ...
    this.alarm.timeSections.forEach((time, index) =>
      time.className == "times mode-active" ? (indexTime = index) : indexTime
    );

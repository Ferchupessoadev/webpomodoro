...
import { msjConfirmSettings, msjAlert } from "./messages.js";

class Alarm {
    constructor() {
        this.main = document.querySelector(".main");
        this.soundHTML = document.getElementById("sonidos");
        this.sound = "digital"; // defecto.
        this.setting = null;
    ...
    reloadTimer() {
        ...
        if (this.timeInProcess) {
            ...
            this.killInterval = false;
            this.colocarContadoresEnCero();
        } else if (this.soundInProcess) this.stopSoundAlert();
    }
    ...
    noCambiarTiempoEnAlerta() {
        ...
        this.toogleBtnStart();
        this.wasFalseTimeRunning = false;
        this.setting.overflowYBody("auto");
    }
    ...
    openModalOfAlert(timeSection, modo) {
        ...
        modo == "settings"
            ? (textModal.innerHTML = msjConfirmSettings)
            : (textModal.innerHTML = msjAlert);
    }

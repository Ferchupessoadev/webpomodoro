class driverOptionsTodoList {
    constructor() {
        ...
        this.containerListTodo.addEventListener("click",e => {
            if(e.target.className === "rotate-arrow-completed"|| e.target.className === "p-tasks p-future" || e.target.className === "p-tasks p-past" || e.target.className === "p-tasks p-today" || e.target.className === "p-tasks p-completed") {
                (e.target.className === "rotate-arrow-completed") ? e.target.parentElement.parentElement.parentElement.children[2].classList.toggle("toggle-section") : e.target.parentElement.parentElement.children[2].classList.toggle("toggle-section");
            }
        })
    }
